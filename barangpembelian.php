                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabelku">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="index.php?page=simpanbaranggudang&kdbl=<?php echo $data['kd_barang_belii']; ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i> Masukan Ke Gudang</button>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
