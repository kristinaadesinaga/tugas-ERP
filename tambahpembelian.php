...
<?php 
	...
	if (isset($_POST['save'])) {
		...
		echo "<script>
			bootbox.confirm('data tersimpan !', function(confirmed){
        	if (confirmed) {
...
?>
			...
			<div class="panel-body">
				<form method="POST">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" name="item" id="item" max="10000000" min="0">
					</div>
	...
	<div class="col-md-12">
		...
		<?php if ($cekbarang === false): ?>
			<button id="formbtn" class="btn btn-primary" name="save" disabled="disabled"><i class="fa fa-save"></i> </button>
		<?php endif ?>
		</div>				
				</form><!--End Form-->
	</div>
